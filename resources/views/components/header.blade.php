...
<div class="offcanvas-menu-wrapper">
    ...
    <div class="offcanvas__nav__option">
        <a href="{{route('frontend.cart')}}" class="btn btn-outline-dark">
            Cart
        </a>
    </div>
    ...
    <div class="container-fluid">
        <div class="row justify-content-center align-items-center  ">
            ...
            <div class="col-lg-6 col-md-6  ">
                <nav class="header__menu mobile-menu mt-2">
                    <ul>
                        ...
                        <li><a href="#">Categories</a>
                            <ul class="dropdown">
                                ...
                                <li class=""><a href="{{route('frontend.category_name',$category->id)}}">{{$category->name}}</a></li>
                                @endforeach
                            </ul>
                        </li>
                        @auth
        ...
        <div class="canvas__open my-2"><i class="fa fa-bars"></i></div>
    </div>
</header>
<!-- Header Section End -->