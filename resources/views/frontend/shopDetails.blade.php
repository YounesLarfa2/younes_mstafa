                ...
                <form id='add-cart-form' method="POST" action="{{ route('add_to_cart', $product->id) }}">
                    ...
                    <div class="row d-flex justify-content-center align-items-center my-5">
                        <div class="col-lg-6  " id="prd_id" prd_id={{ $product->id }}>
                            <div class="">
                                <div class="info_product row justify-content-between pb-5">
                                    ...
                                    <div class="col-sm-6  product__details__option__color" style="text-align: end">
                                        @foreach ($product_colors as $product_color)
                                            <label class="color-check"
                                                ...
                                                for="{{ 'sp-' . $product_color->id }}" color="{{ $product_color->id }}">
                                                <input id='color-inp' name="color" type="radio"
                                                    id="{{ 'sp-' . $product_color->id }}" name="color_id"
                                ...
                                <div class="info_product row justify-content-between pb-5 ">
                                    ...
                                    <div class="col-sm-6  product__details__option__size" style="text-align: end">
                                        @foreach ($product_sizes as $size)
                                            <label for="{{ $size->size }}" class="size-check"
                                                size_id='{{ $size->id }}'>{{ $size->size }}
                                                <input type="radio" id="{{ $size->size }}" id="size_id"
            ...
            <div class="product__details__last__option ">
                ...
                <div class="product__details__cart__option  ">
                    ...
                    <div class="my-3 " style="font-size: 25px;display : flex ;justify-content: end ;align-items : center">
                        <span class="py-2 px-4" class="Available-product">
                            Available
                        </span>

                        <div class="badge py-2 px-4 Available-product-number" id="available-qte">{{ $number }}</div>
                    </div>
